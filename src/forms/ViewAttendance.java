...
public class ViewAttendance extends javax.swing.JFrame {
    ...
    public ViewAttendance() {
        initComponents();
        Utility.setImage(this, "images/background.png", 1101, 501);
    ...
    private void initComponents() {
        ...
        dateChooserTo.setFocusable(false);
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        ...
                        .addComponent(btnResetFilters, javax.swing.GroupLayout.PREFERRED_SIZE, 120, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)))
    ...
    private void loadDataInTable() {
        ...
        sqlQuery += " FROM userdetails AS ud INNER JOIN userattendance AS ua ON ud.id = ua.user_id ";
        if(searchText !=null){
        ...
        try{
            ...
            while(rs.next()){
                ...
                if(uniqueRegIdIncluded){
                    row.add(rs.getString("uniquereqid"));
                }
    ...
    ex.printStackTrace(); // Print the actual error in the console
    JOptionPane.showMessageDialog(null, "Error: " + ex.getMessage()); // Show specific error
}
