...
public class DeleteUser extends javax.swing.JFrame {
    ...
    public DeleteUser() {
        initComponents();
        Utility.setImage(this, "images/background.png", 1087, 491);
    ...
    private void userTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_userTableMouseClicked
        ...
        try{
		int dailogResult = JOptionPane.showConfirmDialog(null,"* User details\n* Images\n* QR codes\n* Attendance\n\nAssociated with this user will be deleted. \nAre you sure you want to proceed?","Confirmation", JOptionPane.YES_NO_OPTION);
		if(dailogResult == JOptionPane.YES_OPTION){
			int index = userTable.getSelectedRow();
			TableModel model = userTable.getModel();
			String email = model.getValueAt(index,3).toString();
			String imagePath = Utility.getPath("/images" + File.separator + email + ".jpg");
			deleteFile(imagePath);
			imagePath = Utility.getPath("/qrCodes" + File.separator + email + ".jpg");
			deleteFile(imagePath);
			Connection connection = ConnectionProvider.getCon();
			String attendanceDeleteQuery = "Delete userattendance,userdetails FROM userdetails LEFT JOIN userattendance ON userattendance.user_id = userdetails.id where userdetails.email = ?";
			...
			JOptionPane.showMessageDialog(null,"Deletion cancled.","Confirmation",JOptionPane.INFORMATION_MESSAGE);
		}
	}catch(Exception ex){
